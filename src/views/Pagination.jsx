    ...
    <ul className='flex gap-2'>
      {pageNumber > 1 && (
        <li
          ...
          className='w-[33px] h-[33px] rounded-full flex justify-center items-center bg-slate-600 text-[#d0d2d6] cursor-pointer hover:bg-indigo-400 shadow-lg hover:shadow-indigo-500/50 hover:text-white'
        >
          <MdOutlineKeyboardDoubleArrowLeft />
        </li>
      )}
